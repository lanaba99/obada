    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                ...
                'type' => 'required|string|max:50|in:shipping,billing', // Assuming default is 'shipping' in migration
                'is_default' => 'boolean', //
            ]);

            // If 'is_default' is true, set other addresses for this user to false
    ...
    public function update(Request $request, Address $address)
    {
        try {
            $validatedData = $request->validate([
                ...
                'type' => 'sometimes|required|string|max:50|in:shipping,billing', //
